...
ところで、標準時と夏時間の移行時の時刻に対しては仕様が定まっていません。東部標準時では夏時間への移行時に 02:00 から 03:00 がスキップされ、夏時間からの移行時に 01:00 から 02:00 が２回繰り返されます。移行時について GLIBC と MSVCRT で検証した結果、以下の通りになりました。
